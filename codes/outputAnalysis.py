...
# convert xml to csv
runfile('E:/SUMO/tools/xml/xml2csv.py',wdir='E:/SUMO/tools/xml', args='E:/SUMO/RUIXIAO/newChattanooganet/SUMO_simulation/EdgeData.xml')
runfile('E:/SUMO/tools/xml/xml2csv.py',wdir='E:/SUMO/tools/xml', args='E:/SUMO/RUIXIAO/newChattanooganet/SUMO_simulation/busstop_output.xml')
runfile('E:/SUMO/tools/xml/xml2csv.py',wdir='E:/SUMO/tools/xml', args='E:/SUMO/RUIXIAO/newChattanooganet/SUMO_simulation/trajectories_output.xml -p')#split the output files based on the first level

# bus stop output containing delay and person load information
stopO = pd.read_csv("E:/SUMO/RUIXIAO/newChattanooganet/SUMO_simulation/busstop_output.csv",sep=';')
...
stopO.to_csv("E:/SUMO/RUIXIAO/newChattanooganet/Data/Output_analysis/busstop_info.csv",index=False)


# edge based output with mean speed for each hour(3600s)
edgeO = pd.read_csv("E:/SUMO/RUIXIAO/newChattanooganet/SUMO_simulation/EdgeData.csv",sep=';')
...
edgeO.to_csv("E:/SUMO/RUIXIAO/newChattanooganet/Data/Output_analysis/edge_info.csv",index=False)


# trajectory for all vehicles
motion = pd.read_csv("E:/SUMO/RUIXIAO/newChattanooganet/SUMO_simulation/trajectories_outputmotionState.csv",sep=';',low_memory=False)
vehtype = pd.read_csv("E:/SUMO/RUIXIAO/newChattanooganet/SUMO_simulation/trajectories_outputactorConfig.csv",sep=';')
vehref = pd.read_csv("E:/SUMO/RUIXIAO/newChattanooganet/SUMO_simulation/trajectories_outputvehicle.csv",sep=';')
...
traj.rename(columns={'motionState_vehicle' : 'vehicle_id','motionState_time':'time','motionState_speed':'speed','motionState_acceleration':'acceleration'},inplace = True)
...
for key, df in trajectory.items():
    bus=key.replace(':','')
    with open('E:/SUMO/RUIXIAO/newChattanooganet/Data/Output_analysis/' + 'Trajectory_' + bus + '.csv', 'w', newline='') as oFile:
