...
For each of the simulation, the folder contains the following file structure:
...
These files can be generated by following the steps in [manual files](manual_files)
