...
## Step 1. Installation and input files
...
For each of the simulation, the following files are necessary:
...
They are stored in separate folders (as shown in the [examples](examples))

All of these files can be generated by following the steps in [manual files](manual_files), but it can be complicated and tedious.

## Step 2. Run simulation

We have set up various examples included with the installation.

<!-- - [HelloWorld](examples/HelloWorld) - a basic example that shows the installation is ready ( it is faster to run) -->
* 1 hour simulation:
...
- Following two simulations show full day results. But will take a long time to run. These will take a longer time (>3 hours, depending on your machine):
